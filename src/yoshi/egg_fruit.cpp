...
static u32 checkFreeEggCard(TEggYoshi *egg) {
  if (!Stage::getStageConfiguration()->mIsEggFree.get()) {
...
SMS_PATCH_BL(SMS_PORT_REGION(0x801BC1E0, 0, 0, 0), checkFreeEggCard);
SMS_WRITE_32(SMS_PORT_REGION(0x801BC1E4, 0, 0, 0), 0x7C601B78);
SMS_WRITE_32(SMS_PORT_REGION(0x801BC1EC, 0, 0, 0), 0x60000000);
SMS_PATCH_BL(SMS_PORT_REGION(0x801BC2C8, 0, 0, 0), checkFreeEggCard);
