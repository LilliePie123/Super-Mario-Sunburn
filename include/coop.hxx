...
namespace SMSCoop {
    inline void setCamera(int i) {
        auto _setCamera = BetterSMS::getExportedFunctionPointer<void (*)(int)>("setCamera__7SMSCoopFi");
        _setCamera(i);
    }
    ...
    inline void setSkinForPlayer(int id, char const *path) {
        auto _setSkinForPlayer =
            BetterSMS::getExportedFunctionPointer<void (*)(int, char const *)>("setSkinForPlayer__7SMSCoopFiPCc");
